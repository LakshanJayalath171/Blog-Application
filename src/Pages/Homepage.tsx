...
const Homepage = () => {
  ...
  return (
    <div>
      ...
      {/* hero section  */}
      <div className="relative h-[50vh] sm:h-[60vh] md:h-[75vh] lg:min-h-screen bg-cover bg-center " style={{ backgroundImage: `url(${hero})` }}>
      <Navbar/>
      <div className="absolute top-1/2 left-10">
        <h1 className="poppins-bold text-4xl text-blue-50">LEARN STACK</h1>
        <h4 className="poppins-light  text-blue-100">Learn Today. Glow Tommorow.</h4>
      </div>
    </div>
    {/* blog category section  */}
     ...
     <div className="mx-2 md:mx-8 grid grid-rows-2 grid-cols-2 md:grid-cols-2 lg:grid-cols-3 ">
     ...
     <div className="grid grid-rows-2 grid-cols-2 md:grid-cols-2 lg:grid-cols-3 mx-2 mb-10 md:px-4">
